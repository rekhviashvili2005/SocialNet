...
public class FollowService : IFollowService
{
    ...
    public FollowService(ApplicationDbContext context, UserManager<ApplicationUser> userManager, IMemoryCache cache)
    {
        _context = context;
    ...
    public async Task FollowAsync(string followerId, string followingId)
    {
        ...
        // cache გასუფთავება — ახლა სხვა სია უნდა გამოჩნდეს
        _cache.Remove($"suggested_{followerId}");
    }
    ...
    public async Task UnFollowAsync(string followerId, string followingId)
    {
        ...
        // cache გასუფთავება — Unfollow-ის შემდეგ ისევ გამოჩნდეს
        _cache.Remove($"suggested_{followerId}");
    }
